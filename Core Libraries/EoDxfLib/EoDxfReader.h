...
class EoDxfReader {
 public:
  ...
  [[nodiscard]] std::wstring DecodeEncodedText(std::string_view encodedText) const { return m_decoder.DecodeText(encodedText); }
  [[nodiscard]] std::wstring GetWideString() const { return DecodeEncodedText(m_encodedText); }
