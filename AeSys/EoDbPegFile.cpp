...
void EoDbPegFile::ReadLinetypeDefinition(double *dashLength, CString &name, CString &description, EoUInt16 &definitionLength) {
	EoDb::Read(*this, name);
...
void EoDb::ConstructDimensionPrimitive(CFile& file, EoDbPrimitive*& primitive) {
	...
	primitive = new EoDbDimension(PenColor, LineType, EoGeLine(BeginPoint, EndPoint),
