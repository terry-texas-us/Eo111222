...
class LayerPropertiesManagerDialog : public CDialog
{
	DECLARE_DYNAMIC(LayerPropertiesManagerDialog)

public:
	LayerPropertiesManagerDialog(CWnd* parent = NULL);   // standard constructor
	LayerPropertiesManagerDialog(OdDbDatabase* database, CWnd* parent = NULL);

	virtual ~LayerPropertiesManagerDialog();
