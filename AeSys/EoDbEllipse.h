...
class EoDbEllipse : public EoDbPrimitive {
 ...
 public:  // Methods - absolute virtuals
  ...
  void Assign(EoDbPrimitive* primitive) { *this = *static_cast<EoDbEllipse*>(primitive); }
  ...
  EoGePoint3d GetCtrlPt() { return (m_ptCenter); }
  ...
  bool Is(EoUInt16 wType) { return wType == EoDb::kEllipsePrimitive; }
  ...
  void Translate(EoGeVector3d v) { m_ptCenter += v; }
