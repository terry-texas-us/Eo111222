...
float EoGsAbstractView::FarClipDistance(void) const {
...
float EoGsAbstractView::NearClipDistance(void) const {
	return m_NearClipDistance;
}
float EoGsAbstractView::Height() const {
	return m_Height;
}
...
float EoGsAbstractView::LensLength() const {
	return m_LensLength;
}
EoGePoint3d EoGsAbstractView::Position(void) const {
	return EoGePoint3d(mx_Position.x, mx_Position.y, mx_Position.z);
}
void EoGsAbstractView::SetFarClipDistance(const float distance) {
...
void EoGsAbstractView::SetNearClipDistance(const float distance) {
...
void EoGsAbstractView::SetLensLength(const float length) {
	m_LensLength = length;
}
...
EoGePoint3d EoGsAbstractView::Target(void) const {
	return EoGePoint3d(mx_Target.x, mx_Target.y, mx_Target.z);
}
EoGeVector3d EoGsAbstractView::ViewUp() const {
	return EoGeVector3d(mx_ViewUp.x, mx_ViewUp.y, mx_ViewUp.z);
}
