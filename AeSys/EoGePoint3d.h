...
class EoGePoint3d {
 ...
 public:
  ...
  EoGePoint3d(const DRW_Coord& point) noexcept : x{point.x}, y{point.y}, z{point.z} {}
 ...
 public:
   ...
   */
  EoGePoint3d ProjectToward(const EoGePoint3d& p, double distance) const;
   ...
   */
  EoGePoint3d RotateAboutAxis(const EoGePoint3d& referenceOrigin, const EoGeVector3d& referenceAxis, double angle);
