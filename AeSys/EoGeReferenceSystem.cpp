...
EoGePoint3d EoGeReferenceSystem::Origin() const {
	return m_Origin;
}
...
void EoGeReferenceSystem::SetOrigin(const EoGePoint3d& origin) {
	m_Origin = origin;
}
void EoGeReferenceSystem::SetXDirection(const EoGeVector3d& xDirection) {
	m_XDirection = xDirection;
}
void EoGeReferenceSystem::SetYDirection(const EoGeVector3d& yDirection) {
	m_YDirection = yDirection;
}
...
EoGeVector3d EoGeReferenceSystem::XDirection() const {
	return m_XDirection;
}
EoGeVector3d EoGeReferenceSystem::YDirection() const {
	return m_YDirection;
}
