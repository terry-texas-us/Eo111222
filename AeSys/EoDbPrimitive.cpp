...
int EoDbPrimitive::IsWithinArea(EoGePoint3d, EoGePoint3d, EoGePoint3d*) {
	return 0;
}
bool EoDbPrimitive::PvtOnCtrlPt(AeSysView*, const EoGePoint4d&) {
	return false;
}
...
EoInt16 EoDbPrimitive::PenColor() const {
	return m_PenColor;
}
EoInt16 EoDbPrimitive::LineType() const {
	return m_LineType;
}
void EoDbPrimitive::PenColor(EoInt16 penColor) {
	m_PenColor = penColor;
}
void EoDbPrimitive::LineType(EoInt16 lineType) {
	m_LineType = lineType;
}

EoUInt16 EoDbPrimitive::ControlPointIndex() {
	return sm_ControlPointIndex;
}
bool EoDbPrimitive::IsSupportedTyp(int iTyp) {
	return (iTyp <= 7 && iTyp != 4 && iTyp != 5);
}
EoInt16 EoDbPrimitive::LayerPenColorIndex() {
	return sm_LayerPenColor;
}
void EoDbPrimitive::SetLayerPenColorIndex(EoInt16 colorIndex) {
	sm_LayerPenColor = colorIndex;
}
...
void EoDbPrimitive::SetLayerLineTypeIndex(EoInt16 lineTypeIndex) {
	sm_LayerLineType = lineTypeIndex;
}
double& EoDbPrimitive::Rel() {
	return sm_RelationshipOfPoint;
}
EoInt16 EoDbPrimitive::SpecialLineTypeIndex() {
	return sm_SpecialLineTypeIndex;
}
EoInt16 EoDbPrimitive::SpecialPenColorIndex() {
	return sm_SpecialPenColorIndex;
}
void EoDbPrimitive::SetSpecialPenColorIndex(EoInt16 colorIndex) {
	sm_SpecialPenColorIndex = colorIndex;
}
