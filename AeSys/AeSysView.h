...
public:
OdGsViewPtr ViewAt(int viewIndex) { return m_Device->viewAt(viewIndex); }
...
/// <param name="group"></param>
void GenerateRectangularElbow(EoGeLine& previousReferenceLine, Section previousSection, EoGeLine& currentReferenceLine,
                              Section currentSection, EoDbGroup* group);
...
void GenerateFullElbowTakeoff(EoDbGroup* existingGroup, EoGeLine& existingSectionReferenceLine, Section existingSection,
                              EoDbGroup* group);
