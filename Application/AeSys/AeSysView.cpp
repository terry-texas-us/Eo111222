...
ON_COMMAND(ID_VIEW_COLORSCHEME_DARK, OnViewColorSchemeDark)
ON_COMMAND(ID_VIEW_COLORSCHEME_LIGHT, OnViewColorSchemeLight)
...
ON_UPDATE_COMMAND_UI(ID_VIEW_COLORSCHEME_DARK, OnUpdateViewColorSchemeDark)
ON_UPDATE_COMMAND_UI(ID_VIEW_COLORSCHEME_LIGHT, OnUpdateViewColorSchemeLight)
#if defined(USING_STATE_PATTERN)
