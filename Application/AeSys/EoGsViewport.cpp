...
void EoGsViewport::SetDeviceHeightInInches(double height) {
  m_DeviceHeightInInches = height;
}
void EoGsViewport::SetDeviceWidthInInches(double width) {
...
void EoGsViewport::SetDeviceHeightInPixels(double height) {
  m_DeviceHeightInPixels = height;
}
void EoGsViewport::SetDeviceWidthInPixels(double width) {
