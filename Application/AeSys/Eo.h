...
[[nodiscard]] inline constexpr COLORREF PaperSpaceSheetColor() noexcept {
  return colorWhite;
}
...
inline void SyncViewBackgroundColor() noexcept {
  ViewBackgroundColor = ModelSpaceBackgroundColor();
}

inline COLORREF GrayPalette[16] = {RGB(255, 255, 255),
    RGB(140, 140, 140),
    RGB(0xbe, 0xbe, 0xbe),
    RGB(0xdc, 0xdc, 0xdc),
    RGB(0xf0, 0xf0, 0xf0),
...
inline COLORREF ColorPalette[256] = {RGB(0, 0, 0),
    RGB(255, 0, 0),
    RGB(255, 255, 0),
    RGB(0, 255, 0),
    RGB(0, 255, 255),
...
constexpr double DegreeToRadian(double angleInDegrees) noexcept {
  return angleInDegrees * Radian;
}
constexpr double RadianToDegree(double angleInRadians) noexcept {
  return angleInRadians * (180.0 / std::numbers::pi);
}
