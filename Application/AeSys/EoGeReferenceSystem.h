...
class EoGeReferenceSystem {
 ...
 public:
   ...
   *  @param characterCellDefinition The character cell definition containing height, rotation angle, slant angle, and
   * expansion factor.
   */
  ...
  /** @brief Returns the transformation matrix that transforms points from the reference system's local coordinate
   ...
   * The X and Y directions are adjusted according to the height, expansion factor, rotation angle, and slant angle
   * defined in the character cell definition.
   * @param characterCellDefinition The character cell definition containing the parameters for rescaling the reference
   * system.
   */
