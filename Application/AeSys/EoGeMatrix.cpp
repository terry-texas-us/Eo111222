...
EoGeMatrixRow& EoGeMatrixRow::operator*=(double d) {
  m_d[0] *= d;
  m_d[1] *= d;
  m_d[2] *= d;
  m_d[3] *= d;
...
EoGeMatrixRow EoGeMatrixRow::operator-(const EoGeMatrixRow& row_) {
...
EoGeMatrixRow EoGeMatrixRow::operator+(const EoGeMatrixRow& row_) const {
  EoGeMatrixRow row = *this;
  return row += row_;
}
