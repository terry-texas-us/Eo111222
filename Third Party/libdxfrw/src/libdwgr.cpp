...
void dwgR::setDebug(DRW::DebugTraceLevel lvl) {
  switch (lvl) {
  case DRW::debug:
...
bool dwgR::testReader() {
  ...
  fileBuf.getBytes(tmpStrData, static_cast<int>(fileBuf.size()));
  dwgBuffer dataBuf(tmpStrData, static_cast<int>(fileBuf.size()));
